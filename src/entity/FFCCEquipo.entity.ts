import {PrimaryColumn, Entity, Column, OneToMany, ManyToOne, JoinColumn} from 'typeorm'
...
export class FFCC_EQUIPOS {
    ...
    @Column({name: 'ID_EQUIPO'}) idEquipo: number
    ...
    @ManyToOne(type => FFCC_CABECERA, cabecera => cabecera.equipos)
